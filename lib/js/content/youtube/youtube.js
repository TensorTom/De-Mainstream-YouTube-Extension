; (function () {
  ...
  function waitForVideoResults() {
    var resultVideochannelLinks = document.querySelectorAll('ytd-video-renderer a.yt-formatted-string.yt-simple-endpoint, yt-formatted-string.ytd-channel-name, .yt-simple-endpoint');
    for (var i = 0; i < resultVideochannelLinks.length; i++) {
      ...
      if (channelIds.indexOf(found) > -1 || channelNames.indexOf(found) > -1) {
        var parent = n.closest("ytd-video-renderer, ytd-compact-video-renderer, ytd-rich-item-renderer");
